...
The dashboard provides a personal workspace for signed-in users.

## Delivered

- Protected app layout shared across private routes
...
The dashboard is the landing surface for authenticated users and links directly to calculator and settings workflows.
